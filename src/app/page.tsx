            ...
            <Canvas style={{ width: '100%', height: '100%' }}>
                <Physics gravity={[0, -1.5, 0]} colliders={false} /*debug*/>
                    <Suspense fallback={<></>}>
                        ...
                        <ImageWall position={[5.65, 1.47, 2.85]} texturePath="/images/other/longpano_a.png" />
                        <ImageWall position={[2.2, 1.47, 6.54]} rotation={[0, Math.PI / -2, 0]} texturePath="/images/other/longpano_b.png" />
